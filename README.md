...
tables generated by the linker. RAM bank 0 contains global data like
process lists. It is also mapped to the +3K area when needed.
...
the reverse for the process switched to.
