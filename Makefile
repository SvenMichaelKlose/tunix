...
ifneq (,$(TARGET), $(COMMODORE_TARGETS))
	c1541 -format "tunix,01" d64 $(D64_TUNIX) -write bin/lisp -write bin/lisp.md -write bin/adjoin.lisp -write bin/alist.lisp -write bin/copy.lisp -write bin/defsetfn.lisp -write bin/dolist.lisp -write bin/dotimes.lisp -write bin/ensure-list.lisp -write bin/env-0.lisp -write bin/env-1.lisp -write bin/env-2.lisp -write bin/env-3.lisp -write bin/equality.lisp -write bin/find.lisp -write bin/group.lisp -write bin/intersect.lisp -write bin/let.lisp -write bin/list.lisp -write bin/macroexpand.lisp -write bin/max.lisp -write bin/nthcdr.lisp -write bin/prog1.lisp -write bin/progn.lisp -write bin/quasiquote.lisp -write bin/queue.lisp -write bin/queue-pop.lisp -write bin/set-difference.lisp -write bin/set-exclusive-or.lisp -write bin/smoke-test.lisp -write bin/source.lisp -write bin/stack.lisp -write bin/subseq.lisp -write bin/subseqp.lisp -write bin/test.lisp -write bin/test-onerror.lisp -write bin/union.lisp -write bin/unique.lisp -write bin/unless.lisp -write bin/when.lisp -write bin/while.lisp -write bin/with.lisp -write bin/with-queue.lisp
endif
