...
PARANOID="$VERBOSE -DEXIT_FAILURE_ON_ERROR -DCHECK_OBJ_POINTERS -DTEST_INTERPRETER -DTEST_ENVIRONMENT -DPARANOID"
...
test_unix "$PARANOID -DTEST_INTERPRETER -DTEST_ENVIRONMENT -DGC_STRESS"
...
tests () {
    ...
    # TODO: NO_BUILTIN_GROUP_SYMBOL_NAME NO_BUILTIN_GROUP_BITOPS 
    for i in NO_BUILTIN_GROUP_DIRECTORY NO_BUILTIN_GROUP_IMAGE NO_BUILTIN_GROUP_RAW_ACCESS; do
        $1 "$PARANOID -D$i"
    done
