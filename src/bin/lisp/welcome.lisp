...
(print '(adjoin aif alist all awhen copy-tree do dolist
         dotimes ensure-list equality every find-if
         find group intersect let list max member-if
         nthcdr prog1 progn queue queue-pop remove-if
         reverse set-difference set-exclusive-or
